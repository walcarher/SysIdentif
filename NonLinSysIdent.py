...
ax4.plot_trisurf(X, Y, Z, linewidth=0.2, antialiased=True, cmap=cm.coolwarm, alpha=0.5)
...
ax6.plot_trisurf(X, Y, Z, linewidth=0.2, antialiased=True, cmap=cm.coolwarm, alpha=0.5)
...
#ax.set_ylim(,)
ax6.set_zlabel('Throughput (KB/s)')
#ax.set_zlim(,)
...
ax7.plot_trisurf(X, Y, Z, linewidth=0.2, antialiased=True, cmap=cm.coolwarm, alpha=0.5)
...
#ax.set_ylim(,)
ax7.set_zlabel('Throughput (KB/s)')
#ax.set_zlim(,)

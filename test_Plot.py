...
#plt.plot(x,std*y_norm+mean,'g',linestyle='dashed', linewidth=3, label='Estimated Energy')
plt.plot(x,std*y+mean,'g',linestyle='dashed', linewidth=3, label='Estimated Energy')
plt.xlabel('Number of Channels (N)')
